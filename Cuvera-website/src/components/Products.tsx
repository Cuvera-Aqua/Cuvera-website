          ...
          {products.map((p) => (
            <div key={p.name} className="product-card" style={{ border: "1px solid #e2e8f0", borderRadius: "16px", overflow: "hidden", transition: "all 0.3s ease", boxShadow: "0 2px 8px rgba(0,0,0,0.04)", background: "#fff" }}>
              ...
              <div style={{ padding: "20px" }}>
                ...
                <a href={WHATSAPP_URL} target="_blank" rel="noopener noreferrer" className="order-btn"
                  style={{ display: "block", textAlign: "center", background: "#2563eb", color: "#fff", padding: "12px", borderRadius: "8px", fontWeight: 600, fontSize: "14px", textDecoration: "none", transition: "background 0.2s" }}>
                  Order Now
                </a>
              </div>
            </div>
