...
export default function Home() {
  ...
  return (
    <div style={{ fontFamily: "'Outfit', sans-serif", color: "#0f172a" }}>
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto", width: "100%", display: "flex", alignItems: "center" }} className="hero-grid">
          ...
          <div style={{ flex: 1, padding: "60px 48px 60px 24px" }} className="hero-text">
            ...
            <div style={{ display: "flex", gap: "16px", flexWrap: "wrap" }} className="cta-btns">
              <a href="#contact" style={{ ...S.btn, background: "#2563eb", color: "#fff" }} className="btn-primary">
                Get Quote
              </a>
              <a href="#contact" style={{ ...S.btn, background: "transparent", color: "#2563eb", border: "2px solid #2563eb" }} className="btn-outline">
                Contact Us
              </a>
            </div>
          </div>
          {/* Right image */}
          <div className="hero-img" style={{ width: "52%", minHeight: "calc(100vh - 70px)", background: "#e2e8f0", overflow: "hidden", position: "relative" }}>
            <img
      ...
      {/* ── STATS ── */}
      <section style={{ padding: "60px 24px", background: "#fff" }} ref={statsRef}>
      ...
      <section style={{ padding: "80px 24px", background: "#fff" }} id="products">
        <div style={S.section}>
          <h2 style={S.sectionTitle}>Our <span style={S.blueText}>Products</span></h2>
          <p style={S.sectionSub}>Choose from our range of pure, copper-infused drinking water products for every need</p>
            ...
            {products.map((p) => (
              <div key={p.name} className="product-card" style={{ border: "1px solid #e2e8f0", borderRadius: "16px", overflow: "hidden", transition: "all 0.3s ease", boxShadow: "0 2px 8px rgba(0,0,0,0.04)", background: "#fff" }}>
                ...
                <div style={{ padding: "20px" }}>
                  ...
                  <p style={{ fontSize: "13px", color: "#64748b", marginBottom: "8px" }}>{p.tagline}</p>
                  <p style={{ fontSize: "13px", color: "#94a3b8", marginBottom: "20px" }}>{p.desc}</p>
                  <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="order-btn" style={{ display: "block", textAlign: "center", background: "#2563eb", color: "#fff", padding: "12px", borderRadius: "8px", fontWeight: 600, fontSize: "14px", textDecoration: "none", transition: "background 0.2s" }}>
                    Order Now
                  </a>
                </div>
              </div>
      ...
      <section style={{ padding: "80px 24px", background: "#f8fafc" }} id="branding">
        <div style={{ maxWidth: "1200px", margin: "0 auto", display: "flex", alignItems: "center", gap: "64px" }} className="branding-grid">
          <div style={{ flex: 1 }}>
            ...
            <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" style={{ ...S.btn, background: "#2563eb", color: "#fff", textDecoration: "none" }} className="btn-primary">
      ...
      <section style={{ padding: "80px 24px", background: "#fff" }}>
        <div style={S.section}>
          ...
          <div style={{ display: "grid", gap: "24px" }} className="features-grid">
            {features.map((f) => (
              <div key={f.title} className="feature-card" style={{ padding: "28px", border: "1px solid #e2e8f0", borderRadius: "16px", transition: "all 0.2s ease", background: "#fff" }}>
      ...
      <section style={{ background: "linear-gradient(135deg, #2563eb, #0891b2)", padding: "72px 24px", textAlign: "center" }}>
        <h2 style={{ fontSize: "clamp(26px, 4vw, 40px)", fontWeight: 800, color: "#fff", marginBottom: "16px" }}>Bulk & Wholesale Supply</h2>
        <p style={{ fontSize: "16px", color: "#bfdbfe", marginBottom: "36px", maxWidth: "600px", margin: "0 auto 36px" }}>
        ...
        <div style={{ display: "flex", gap: "16px", justifyContent: "center", flexWrap: "wrap" }}>
          <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" style={{ ...S.btn, background: "#fff", color: "#2563eb", textDecoration: "none" }}>
            Get Wholesale Pricing
          </a>
          <a href="#contact" style={{ ...S.btn, background: "transparent", color: "#fff", border: "2px solid #fff", textDecoration: "none" }}>
            Contact Sales Team
          </a>
        </div>
      </section>
      ...
      <section style={{ padding: "80px 24px", background: "#fff" }} id="contact">
        <div style={{ maxWidth: "1200px", margin: "0 auto", display: "flex", gap: "64px", alignItems: "flex-start" }} className="contact-grid">
          ...
          <div style={{ flex: 1 }}>
            ...
            {[
              { icon: "📱", label: "WhatsApp", value: "+91 9721785327", href: whatsappUrl },
          ...
          <div style={{ flex: 1, background: "#fff", border: "1px solid #e2e8f0", borderRadius: "16px", padding: "36px", boxShadow: "0 4px 24px rgba(0,0,0,0.06)" }}>
            ...
            {["Name", "Email", "Phone"].map((field) => (
              <div key={field} style={{ marginBottom: "16px" }}>
                <label style={{ display: "block", fontSize: "13px", fontWeight: 500, marginBottom: "6px", color: "#374151" }}>{field}</label>
                <input
                  type={field === "Email" ? "email" : field === "Phone" ? "tel" : "text"}
                  placeholder={field === "Phone" ? "+91 XXXXXXXXXX" : `Your ${field.toLowerCase()}`}
                  style={{ width: "100%", padding: "12px 14px", border: "1px solid #e2e8f0", borderRadius: "8px", fontSize: "14px", color: "#0f172a", transition: "border 0.2s" }}
                />
              </div>
            ))}
            <div style={{ marginBottom: "20px" }}>
              ...
              <textarea
                ...
                rows={4}
                style={{ width: "100%", padding: "12px 14px", border: "1px solid #e2e8f0", borderRadius: "8px", fontSize: "14px", color: "#0f172a", resize: "vertical", transition: "border 0.2s" }}
              />
            </div>
            <button className="btn-primary" style={{ ...S.btn, width: "100%", background: "linear-gradient(90deg, #2563eb, #0891b2)", color: "#fff", textAlign: "center" as const }}>
              Send Message
            </button>
          </div>
        </div>
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr 1fr", gap: "40px", marginBottom: "48px" }} className="footer-grid">
            ...
            <div>
              ...
              <p style={{ fontSize: "14px", lineHeight: 1.7 }}>Pure, copper-infused drinking water for a healthier lifestyle.</p>
            </div>
            {/* Quick Links */}
            <div>
              ...
              {["About Us", "Products", "Custom Branding", "Contact"].map((l) => (
                <a key={l} href={`#${l.toLowerCase().replace(" ", "")}`} style={{ display: "block", fontSize: "14px", color: "#94a3b8", textDecoration: "none", marginBottom: "10px" }}>{l}</a>
              ))}
            </div>
            {/* Products */}
            <div>
